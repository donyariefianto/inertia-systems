          ...
          <div class="space-y-8" in:fade>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              ...
              <div class="space-y-4">
                <label
                  for="type-identifier"
                  class="block text-[10px] font-black uppercase opacity-40">Type Identifier</label
                >
                <div
                ...
                <div class="p-5 bg-card shrink-0 space-y-5" transition:slide>
                  <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                    <div class="md:col-span-7 space-y-1.5">
                      <label
                        for="field-type-{idx}"
                        class="block text-[9px] font-black text-muted-foreground uppercase"
                        >Data Type</label
                      >
                      <div class="relative">
                        <select
                  ...
                  {#if field.type === 'relation'}
                    ...
                    >
                      <div
                        class="flex items-center gap-2 text-indigo-500 border-b border-indigo-500/20 pb-2"
                      >
                        <i class="fas fa-link"></i>
                        <span class="text-[10px] font-black uppercase tracking-widest"
                          >Relationship Config</span
                        >
                      </div>
                  ...
                  {#if field.type === 'repeater'}
                    ...
                    >
                      ...
                      >
                        ...
                        <button
                          onclick={() => {
                            ...
                            field.sub_fields.push({ name: '', label: '', type: 'text' })
                            isDirty = true
                          }}
                      ...
                      <div
                        class="p-3 bg-muted/10 space-y-2 max-h-[300px] overflow-y-auto custom-scrollbar"
                      >
      ...
      >
        ...
        <div class="flex items-center gap-1">
          ...
          {#if node.sub_sidemenu}
            ...
            >
              <i class="fas fa-chevron-{node.expanded ? 'down' : 'right'} text-[8px] opacity-40"
              ></i>
            </button>
          {/if}
        </div>
