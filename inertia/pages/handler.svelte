 ...
 {#if isMounted}
  ...
  >
   ...
   >
    ...
    <div
     class="absolute inset-0 animate-[ping_3s_linear_infinite] rounded-full border border-primary/20 opacity-20"
    ></div>
   ...
   <div class="mt-8 text-center" in:fly={{ y: 10, duration: 800, delay: 400 }}>
    ...
    <div class="mt-4 flex flex-col items-center gap-1">
     <p class="text-sm font-medium text-foreground">
      Menyiapkan modul <span class="rounded bg-muted px-1.5 py-0.5 font-mono text-primary"
       >/{path?.split('/').pop()}</span
      >
     </p>
     <div class="flex items-center gap-1.5">
      ...
      <div class="flex gap-1">
       <span class="h-1 w-1 animate-bounce rounded-full bg-primary/40" style="animation-delay: 0ms"
       ></span>
       <span
        class="h-1 w-1 animate-bounce rounded-full bg-primary/40"
