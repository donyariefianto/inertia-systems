...
>
 ...
 >
  ...
  <div class="relative z-10 flex items-center gap-3">
   ...
   <span class="text-2xl font-bold tracking-wide">AION<span class="opacity-80">System</span></span>
  </div>
  ...
  <div class="relative z-10 max-w-md">
   ...
   <p class="mt-4 text-lg opacity-80">
    ...
    solutions autonomously. Built with cutting-edge technology to transcend traditional monitoring
    boundaries.
   </p>
  </div>
  ...
  <div class="w-full max-w-sm space-y-8">
   ...
   <div>
    ...
    <p class="mt-2 text-sm text-muted-foreground">
     Silakan login untuk melanjutkan ke panel kontrol.
    </p>
   </div>
